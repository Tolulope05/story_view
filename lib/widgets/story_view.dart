...
class StoryItem {
  ...
  factory StoryItem.pageVideo(
    ...
    Key? key,
    Duration? duration,
    BoxFit imageFit = BoxFit
        .fitWidth, // this parameter is not used for video but kept for compatibility
    Widget? caption,
    bool shown = false,
    Map<String, dynamic>? requestHeaders,
    Widget? loadingWidget,
    Widget? errorWidget,
    bool useCache = true, // ← NEW: Add this line
  }) {
    return StoryItem(
      Container(
        key: key,
        ...
        child: Stack(
          children: <Widget>[
            StoryVideo.url(
              ...
              loadingWidget: loadingWidget,
              errorWidget: errorWidget,
              useCache: useCache, // ← NEW: Pass it here
            ),
            SafeArea(
              child: Align(
                alignment: Alignment.bottomCenter,
